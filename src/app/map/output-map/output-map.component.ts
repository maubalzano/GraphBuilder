...
@Component({
  selector: 'graph-output-map',
  templateUrl: './output-map.component.html',
  styleUrls: ['./output-map.component.css']
})
export class OutputMapComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get<any>('https://code.highcharts.com/mapdata/custom/world.geo.json')
      .subscribe(data => {
        this.worldMap = data;
        console.log(data);
        Highmaps.mapChart('mapcontainer', this.chartOptions);
      })
